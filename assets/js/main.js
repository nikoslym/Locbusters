...
const TRANSLATIONS = {
  en: {
    ...
    'rentalsPage.r1.desc':  'Infrastructure for crew support, comfort, and preparation.\nShelter, seating, dining, and make-up/wardrobe stations fully equipped for every production need.',
  ...
  gr: {
    ...
    'aboutPage.abt.p3':   'Εστιάζουμε στην ενοποίηση υπηρεσιών, διαχειριζόμενές τες ως ένα ενιαίο και συντονισμένο σύστημα: Διαχείριση βάσεων, προσωρινών υποδομών και τοποθεσιών γυρίσματος, ενοικίαση εξοπλισμού, επιχειρησιακή οργάνωση.',
    ...
    'rentalsPage.subtitle': 'Κορυφαίας ποιότητας εξοπλισμός υποστήριξης, για κάθε στάδιο της παραγωγής.',
