...
const TRANSLATIONS = {
  en: {
    ...
    'aboutPage.abt.p2':   'We were built from within the industry, as professionals who have spent years working on international & domestic sets in real production environments.',
    'aboutPage.abt.p3':   'Our focus is on integrating services. Unit support, equipment rental, location & unit logistics - operating as one coordinated system.',
    ...
    'aboutPage.story.p1': 'Founded in 2024, The Locbusters was created from within the production world. Built on years of shared work across international and domestic productions in Greece, the founders have collaborated repeatedly - both as a full team and in varying configurations - on projects ranging from independent feature & short films to large-scale studio productions.',
    'aboutPage.story.p1b': 'This long-standing working relationship existed well before the company itself and was shaped through real production environments where time matters and pressure, complexity and precision define every decision.',
    'aboutPage.story.p2': 'As Greece has become a major destination for global filming, and also domestic production has become more demanding, the need for a trusted operational layer has become essential. We built that layer.',
    'aboutPage.story.p2b': 'What unified us was a consistent way of working: trust, respect, precision and a shared understanding of what production support must deliver on the ground.',
    ...
    'servicesPage.s3.desc':  'On-set and on-location operational support, ensuring continuity, efficiency, and execution.\nDelivered in collaboration with experienced professional teams.',
    ...
    'servicesPage.s6.desc1': 'We identify, assess, and manage risk across locations and set environments.',
    'servicesPage.s6.desc2': 'Through detailed evaluations and practical solutions, we ensure productions operate with safety, before and during every shoot.',
    'servicesPage.s7.title': 'Event Planning',
    'servicesPage.s7.desc1': 'End-to-end execution of events, combining production-level structure with a curated network of premium collaborators.',
    'servicesPage.s7.desc2': 'Includes catering, styling, logistics, transportation, VIP drivers, and location sourcing with permit acquisition for unique spaces.',
  ...
  gr: {
    ...
    'aboutPage.abt.p2':   'Δημιουργηθήκαμε από επαγγελματίες του κλάδου, ανθρώπους που έχουν περάσει χρόνια δουλεύοντας σε διεθνή και εγχώρια κινηματογραφικά και τηλεοπτικά γυρίσματα, κάτω από πραγματικές συνθήκες παραγωγής.',
    'aboutPage.abt.p3':   'Εστιάζουμε στην ενοποίηση υπηρεσιών διαχειρίζοντάς τες ως ένα ενιαίο και συντονισμένο σύστημα: Διαχείριση βάσεων, προσωρινών υποδομών και τοποθεσιών γυρίσματος, ενοικίαση εξοπλισμού, επιχειρησιακή οργάνωση.',
    'aboutPage.abt.p4':   'Εργαζόμαστε εκεί που γίνεται η παραγωγή.',
    ...
    'aboutPage.story.p1': 'Η The Locbusters ιδρύθηκε το 2024 Βασισμένη σε χρόνια κοινής επαγγελματικής πορείας σε διεθνείς και εγχώριες παραγωγές στην Ελλάδα, οι ιδρυτές της έχουν συνεργαστεί επανειλημμένα — τόσο ως ομάδα όσο και σε διαφορετικές συνθέσεις — σε παραγωγές που κυμαίνονται από ανεξάρτητες ταινίες μεγάλου και μικρού μήκους έως μεγάλες παραγωγές διεθνών στούντιο.',
    'aboutPage.story.p1b': 'Αυτή η μακροχρόνια επαγγελματική σχέση προϋπήρχε της εταιρείας και διαμορφώθηκε μέσα από πραγματικές συνθήκες παραγωγής, όπου ο χρόνος είναι κρίσιμος και η πίεση, η πολυπλοκότητα και η ακρίβεια καθορίζουν κάθε απόφαση.',
    'aboutPage.story.p2': 'Καθώς η Ελλάδα εξελίσσεται σε σημαντικό προορισμό για διεθνή γυρίσματα και οι εγχώριες παραγωγές γίνονται ολοένα και πιο απαιτητικές, η ανάγκη για ένα αξιόπιστο επιχειρησιακό επίπεδο υποστήριξης έχει καταστεί απαραίτητη. Οι Locbusters είναι αυτό το επίπεδο υποστήριξης κάθε παραγωγής.',
    'aboutPage.story.p2b': 'Αυτό που μας ενώνει είναι ο κοινός τρόπος εργασίας: η εμπιστοσύνη, ο σεβασμός, η ακρίβεια και μια κοινή αντίληψη για το τι οφείλει να προσφέρει η υποστήριξη παραγωγής στο πεδίο.',
    ...
    'servicesPage.s6.desc1': 'Αναγνωρίζουμε, αξιολογούμε και διαχειριζόμαστε την ύπαρξη κινδύνου σε τοποθεσίες και χώρους γυρισμάτων.',
    'servicesPage.s6.desc2': 'Μέσω λεπτομερών αξιολογήσεων και πρακτικών λύσεων, διασφαλίζουμε ότι οι παραγωγές λειτουργούν με ασφάλεια πριν και κατά τη διάρκεια κάθε γυρίσματος.',
    'servicesPage.s7.title': 'Διοργάνωση Εκδηλώσεων',
    'servicesPage.s7.desc1': 'Ολοκληρωμένη υλοποίηση εκδηλώσεων μέσω ενός επιλεγμένου δικτύου εξειδικευμένων συνεργατών.',
    'servicesPage.s7.desc2': 'Ενδεικτικά οι υπηρεσίες περιλαμβάνουν: catering, styling, logistics, μεταφορές, VIP οδηγούς, εύρεση τοποθεσιών και εξασφάλιση αδειών για μοναδικούς χώρους.',
