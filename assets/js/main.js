...
const TRANSLATIONS = {
  en: {
    ...
    'services.s1.desc':  'Full production base setup and operational coordination. Efficient, fully equipped environments from prep to wrap.',
    'services.s2.title': 'Location & Production Logistics',
    'services.s2.desc':  'Coordination of locations, teams, and infrastructure for complex productions. Seamless operational flow across all stages.',
    ...
    'rentals.r1.title': 'Holding Areas & Green Rooms',
    'rentals.r1.desc':  'Tents, shelters, heaters, AC units, umbrellas',
    'rentals.r2.title': 'Catering & Rest Areas',
    'rentals.r2.desc':  'Tables, chairs, dining setup, crew comfort',
    'rentals.r3.title': 'Make-Up & Wardrobe',
    'rentals.r3.desc':  'Mirrors, racks, ironing sets, prep equipment',
    'rentals.r4.title': 'Power & Utilities',
    'rentals.r4.desc':  'Generators, EcoFlow systems, solar panels, LED lighting',
    'rentals.r5.title': 'Accessories',
    'rentals.r5.desc':  'Trolleys, carts, barriers, traffic cones, safety gear',
    'rentals.r6.title': 'Vehicles',
    'rentals.r6.desc':  'Production vans, equipment transport solutions',
    ...
    'footer.s3':  'Traffic Control',
    'footer.s4':  'Green Filming & Sustainability',
    'footer.s5':  'Custom Solutions',
    'footer.r1':  'Holding Areas & Green Rooms',
    'footer.r2':  'Catering & Rest Areas',
    'footer.r3':  'Make-Up & Wardrobe',
    'footer.r4':  'Power & Utilities',
    'footer.r5':  'Accessories',
    'footer.r6':  'Vehicles',
  ...
  gr: {
    ...
    'rentals.r1.title': 'Χώροι Αναμονής & Green Rooms',
    'rentals.r1.desc':  'Σκηνές, καλύμματα, θερμάστρες, κλιματιστικά, ομπρέλες',
    'rentals.r2.title': 'Χώροι Catering & Ανάπαυσης',
    'rentals.r2.desc':  'Τραπέζια, καρέκλες, εξοπλισμός dining, άνεση crew',
    'rentals.r3.title': 'Make-Up & Wardrobe',
    'rentals.r3.desc':  'Καθρέφτες, ράφια, σίδερα, εξοπλισμός προετοιμασίας',
    'rentals.r4.title': 'Ισχύς & Υπηρεσίες',
    'rentals.r4.desc':  'Γεννήτριες, EcoFlow συστήματα, ηλιακά πάνελ, LED φωτισμός',
    'rentals.r5.title': 'Αξεσουάρ',
    'rentals.r5.desc':  'Καρότσια, κώνοι, φράγματα, εξοπλισμός ασφαλείας',
    'rentals.r6.title': 'Οχήματα',
    'rentals.r6.desc':  'Βαν παραγωγής, λύσεις μεταφοράς εξοπλισμού',
    ...
    'footer.s3':  'Ρύθμιση Κυκλοφορίας',
    'footer.s4':  'Πράσινα Γυρίσματα & Βιωσιμότητα',
    'footer.s5':  'Προσαρμοσμένες Λύσεις',
    'footer.r1':  'Χώροι Αναμονής & Green Rooms',
    'footer.r2':  'Χώροι Catering & Ανάπαυσης',
    'footer.r3':  'Make-Up & Wardrobe',
    'footer.r4':  'Ισχύς & Υπηρεσίες',
    'footer.r5':  'Αξεσουάρ',
    'footer.r6':  'Οχήματα',
