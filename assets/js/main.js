...
const TRANSLATIONS = {
  en: {
    ...
    'hero.body1':    'The Locbusters is a boutique production support company in Greece, offering unit services, equipment rental, and location logistics for international and domestic productions.',
    'hero.body2':    'We combine film production support, unit expertise, and location intelligence with on-set equipment rental and film logistics, ensuring that every shoot runs with precision, efficiency, and complete operational clarity.',
    ...
    'services.s2.desc':  'Coordination of locations, teams, and infrastructure for complex productions, delivering location management and film logistics across all stages of production.',
    ...
    'aboutPage.abt.p1':   'We are a boutique film production support team based in Athens, Greece.',
    ...
    'servicesPage.subtitle': 'Unit services, location management, film logistics, and green filming for international productions in Greece.',
    ...
    'servicesPage.s2.desc':  'Coordination of locations, teams, and infrastructure for complex productions, delivering location management and film logistics across all stages of production.',
    ...
    'contactPage.error.submit':     'We couldn\'t send your message. Please try again or email us directly.',
  ...
  gr: {
    ...
    'rentalsPage.subtitle': 'Απαραίτητος εξοπλισμός στο σετ, που υποστηρίζει κάθε στάδιο της παραγωγής.',
    ...
    'contactPage.trust':    'Παραγωγές & Συνεργάτες',
    ...
    'contactPage.error.submit':     'Δεν ήταν δυνατή η αποστολή του μηνύματός σας. Δοκιμάστε ξανά ή στείλτε μας email.',
